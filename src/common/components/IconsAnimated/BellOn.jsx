...
const useStyles = makeStyles((theme) => ({
  ...
  crownStop: {
    animation: `$crown 1s 3 cubic-bezier(0.25, 0.46, 0.45, 1)`,
  },
  pendulumStop: {
    animation: `$pendulum 1s 3 cubic-bezier(0.25, 0.46, 0.45, 1)`,
  },
}));
...
const BellOn = ({ color, animated=true, uniqAnimation=false, }) => {
  ...
  return (
    ...
    >
      ...
      <g className={`${animated ? (uniqAnimation ? styles.pendulumStop :  styles.pendulum) : '' }`}>
        <path
