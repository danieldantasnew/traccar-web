...
const useStyles = makeStyles((theme) => ({
  ...
  sounds: {
    ...
    position: "absolute",
    animation: `$sounds .5s infinite cubic-bezier(1, .5, .5, 1)`,
  },
  sound1: {
...
const BellOn = ({ color }) => {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div>
        <span className={`${styles.sounds} ${styles.sound1}`}></span>
        <span className={`${styles.sounds} ${styles.sound2}`}></span>
        <span className={`${styles.sounds} ${styles.sound3}`}></span>
        <span className={`${styles.sounds} ${styles.sound4}`}></span>
      </div>
    </div>
  );
};
