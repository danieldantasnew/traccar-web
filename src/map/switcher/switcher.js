...
export class SwitcherControl {
  ...
  onAdd(map) {
    ...
    this.styleButton.title = 'Alterar mapa';

    this.styleButton.addEventListener("click", () => {
      const isVisible = this.mapStyleContainer.style.display === "block";
      this.mapStyleContainer.style.display = isVisible ? "none" : "block";
    });
